...
%   MSSeries, ScanPathSeries, ScanPathSeriesT, ScanPathSeriesBins. Windows: BL [-1.5 -0.5], early [0 1], late [1 2], full [0 2] s
...
for subj = 1:length(subjects)
    ...
    clc
    disp(['GAZE FEX STERNBERG Subject ' num2str(subj) '/' num2str(length(subjects)) ' done.'])
...
save(fullfile(paths.features, 'AOC_gaze_matrix_sternberg_trials.mat'), 'gaze_data_sternberg_trials')
