...
gaze_data_sternberg = struct('Trial', {}, 'ID', {}, 'Condition', {}, 'GazeDeviation', {}, ...
...
for subj = 1:length(subjects)
    ...
    for trl = 1:length(dataet.trialinfo)
        ...
        %% Scan Path Length
        %  Aggregate for each trial
        %  Also compute timepoint by timepoint scan path length data
    ...
    subj_data_gaze_trials = struct('ID', num2cell(subject_id), ...
    ...
    l2 = subj_data_gaze_trials([subj_data_gaze_trials.Condition] == 2);
    ...
    l4 = subj_data_gaze_trials([subj_data_gaze_trials.Condition] == 4);
    ...
    l6 = subj_data_gaze_trials([subj_data_gaze_trials.Condition] == 6);
    ...
    gaze_data_sternberg_trials = [gaze_data_sternberg; subj_data_gaze_trials];
