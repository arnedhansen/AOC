...
path = paths.features;
figDir = fullfile(paths.figures, 'eeg', 'ersd', 'hardcoded_electrodes');
...
%% HARDCODED ELECTRODES
chPlot = {'POz', 'PO3', 'PO4', 'PPO5h', 'PPO6h', 'PPO1', 'PPO2', 'Pz', 'P1', 'P2', 'P3', 'P4', 'P5', 'P6'};
...
drawnow; pause(0.05);
saveas(gcf, fullfile(figDir, 'AOC_eeg_ersd_nback_timecourse_ELECTRODES.png'));
...
drawnow; pause(0.05);
saveas(gcf, fullfile(figDir, 'AOC_eeg_ersd_nback_topos_ELECTRODES.png'));