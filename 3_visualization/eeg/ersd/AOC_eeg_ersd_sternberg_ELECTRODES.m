...
chPlot = {'POz', 'POO3h', 'POO4h', 'PO4', 'PPO1', 'PPO2', 'PPO6h', 'P2', 'P4', 'P6'};
...
drawnow; pause(0.05);
saveas(gcf, fullfile(figDir, 'AOC_eeg_ersd_sternberg_timecourse_ELECTRODES.png'));
...
drawnow; pause(0.05);
saveas(gcf, fullfile(figDir, 'AOC_eeg_ersd_sternberg_topos_ELECTRODES.png'));
