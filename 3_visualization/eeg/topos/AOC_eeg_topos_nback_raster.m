...
% Collapse across all conditions
gatfr = gatfr1;
gatfr.powspctrm = (gatfr1.powspctrm + gatfr2.powspctrm + gatfr3.powspctrm) / 3;
...
sgtitle('N-back Theta, Alpha, and Beta Topoplots over Time', 'FontSize', 20, 'FontWeight', 'bold')
...
% Save figure
saveas(gcf, '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/eeg/topos/raster/AOC_alpha_power_nback_rasterplot.png');
