%% AOC TFR Raster Condition Difference — Sternberg (Baselined)
% Loads tfr_stern (tfr*_bl), grand-averages, computes difference
% (WM load 6 - WM load 2), and plots raster TFR topoplots. Saves figures.
%
% Key outputs:
...
gatfr_diff = gatfr6;
gatfr_diff.powspctrm = gatfr6.powspctrm - gatfr2.powspctrm;
...
sgtitle('Sternberg Condition Difference (WM Load 6 - WM Load 2) over Time', 'FontSize', 20, 'FontWeight', 'bold')
...
% Save figure
saveas(gcf, '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/eeg/topos/raster/AOC_eeg_topos_sternberg_raster_condDiff.png');
