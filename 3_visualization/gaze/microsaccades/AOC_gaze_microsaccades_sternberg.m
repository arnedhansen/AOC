%% AOC Gaze Microsaccade Suppression — Sternberg
...
tName   = 'sternberg';
tFile   = 'dataET_sternberg';
cCodes  = [2 4 6];
cLabels = {'WM load 2', 'WM load 4', 'WM load 6'};
...
saveas(gcf, fullfile(figpath, 'AOC_gaze_microsaccades_raster_sternberg.png'));
