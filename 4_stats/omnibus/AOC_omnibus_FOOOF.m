...
% F-test colormap: white (0) -> yellow -> orange -> red (custom; cbrewer YlOrRd can show blue-green)
key = [0 0.33 0.66 1];
...
% --- Sternberg: 2x2 composite (from saved PNGs) --- (from saved PNGs) ---
...
% --- N-back: 2x2 composite (from saved PNGs) --- (from saved PNGs) ---
