%% AOC Omnibus — N-Back: Split by Alpha Power Change (Eye Velocity)
...
for analysis_idx = 1:length(all_analyses)
    ...
    for subj = 1:length(subjects)
        ...
        for trl = 1:n_trials
            if ~trial_mask(trl), continue; end
    ...
    title(sprintf('N-Back Eye Velocity: Alpha Reduction vs Amplification (%s)', analysis_name), ...
    ...
    fig_name = sprintf('AOC_omnibus_splitAlpha_nback_velocity_%s.png', cond_label);
