#!/usr/bin/env Rscript
# AOC GLMMs — Sternberg (trial-level)
# Loads AOC_merged_data_sternberg_trials.csv and fits mixed models.
...
message("=== AOC GLMMs (trials): Sternberg ===")
results <- run_paper_glmm_trials(STERNBERG_TASK_CONFIG_TRIALS)
