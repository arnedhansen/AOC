...
%% Load data
load('/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/data/features/merged_data_nback_trials.mat')
...
for subj = 1:length(subjects)
    ...
    disp('Extracting SPL')
    subjTable = merged_data_nback_trials(merged_data_nback_trials.ID == subjID, :);
    ...
    % saveas(gcf, fullfile('/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/interactions/subjects/', ['AOC_nback_SPL_binned_medianSplit_' subjects{subj} '.png']))
    ...
    try
        ...
        cd(datapath_eeg)
        load tfr_nback_trials   % tfr_all (dimord 'rpt_chan_freq_time'), trialinfo(:,2) = Trial
    catch
    ...
    try
        datapath_gaze = fullfile('/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/data/features', subjects{subj}, 'gaze', 'gaze_series_nback_trials.mat');
...
%% Save VARIABLES
save '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/data/features/AOC_interaction_SPLxTFR_nback' ...
    gatfr_low gatfr_high scan_low scan_high scan_low_full scan_high_full time_series datTS t_plot_full
%load('/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/data/features/AOC_interaction_SPLxTFR_nback');
...
title('N-back TFR — LOW SPL trials');
saveas(gcf, '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/interactions/AOC_nback_TFR_LOW_SPL_trials.png');
...
set(gca, 'FontSize', fontSize);
title('N-back TFR — HIGH SPL trials');
saveas(gcf, '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/interactions/AOC_nback_TFR_HIGH_SPL_trials.png');
...
rectangle('Position', [0, 8, 2, 6], 'EdgeColor', 'k', 'LineWidth', 4);
set(gca, 'FontSize', fontSize);
title('N-back TFR — DIFF (HIGH SPL - LOW SPL trials)');
saveas(gcf, '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/interactions/AOC_nback_TFR_DIFF_SPL_trials.png');
...
title('N-back SPLxAlpha (LOW vs HIGH SPL trials)')
xlim([-.5 2])
set(gca, 'FontSize', fontSize)
box on
yline(0, '--')
...
saveas(gcf, '/Volumes/g_psyplafor_methlab$/Students/Arne/AOC/figures/interactions/AOC_nback_SPLOxTFR_Subplots.png')