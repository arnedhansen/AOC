...
for subjects = 1 : length(subjectIDs)
    ...
    filePathET = ['/Volumes/methlab/Students/Arne/AOC/data/raw/', char(subjectID)];
    ...
    for files = 1 : size(dEEG, 1)
        ...
        %% Merge files
        EEG = pop_importeyetracker(EEG, ETfile,[startTrigger endTrigger],[2 3 4],{'L_GAZE_X', 'L_GAZE_Y', 'L_AREA'},1,1,1,0); % ADJUST WITH RIGHT EYE AND DISTANCE AND PUPIL SIZE
        %% Save to disk
