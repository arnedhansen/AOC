...
behav_data_nback = struct('ID', {}, 'Trial', {}, 'Condition', {}, 'Accuracy', {}, 'ReactionTime', {}, 'Stimuli', {}, 'Match', {});
...
for subj = 1:length(subjects)
    ...
    subj_data_behav = struct('ID', subject_id, 'Trial', num2cell(trial_num), 'Condition', condition, ...
