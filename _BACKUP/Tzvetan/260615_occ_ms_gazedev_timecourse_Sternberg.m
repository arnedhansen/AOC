%% Sternberg gaze deviation and microsaccade-rate time courses
...
for s = 1:length(subjects)
    ...
    % select conditions
    trl1 = find(dataSternberg.trialinfo == 22);% load 2
    trl2 = find(dataSternberg.trialinfo == 24);% load 4
    trl3 = find(dataSternberg.trialinfo == 26);% load 6
