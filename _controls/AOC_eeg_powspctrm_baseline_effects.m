...
% period [-0.5 0]s vs the retention period [0 2]s for both tasks.
%
...
%   Left panel:   Raw baseline [-0.5 0]s power spectra per condition
...
for t = 1:numel(tasks)
    ...
    title('Baseline [-0.5 0]s', 'FontSize', 20);
