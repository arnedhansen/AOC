...
ggsave(file.path(storage_plot, "AOC_multiverse_nback_estimate.png"), plot = p_combined, width = 14, height = 12, dpi = 300)
message("Saved AOC_multiverse_nback.png to ", storage_plot)
...
ggsave(file.path(storage_plot, "AOC_multiverse_nback_conditions.png"),
       plot = p_cond_combined, width = 16, height = 12, dpi = 300)
message("Saved AOC_multiverse_nback_conditions.png to ", storage_plot)
