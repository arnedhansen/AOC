...
if ("aperiodic_offset" %in% names(dat) && "aperiodic_exponent" %in% names(dat)) {
  ...
  if (nrow(M_ap_gaze_results) > 0) {
    ...
    write.csv(M_ap_gaze_results, file.path(csv_dir, "multiverse_nback_aperiodic_gaze_results.csv"), row.names = FALSE)
  ...
  if (nrow(M_ap_cond_results) > 0) {
    ...
    write.csv(M_ap_cond_results, file.path(csv_dir, "multiverse_nback_aperiodic_condition_results.csv"), row.names = FALSE)
