...
ggsave(file.path(storage_plot, "AOC_multiverse_sternberg_estimate.png"), plot = p_combined, width = 14, height = 12, dpi = 600)
message("Saved AOC_multiverse_sternberg_estimate.png to ", storage_plot)
...
# Extracts highest condition term (e.g. Condition6 vs reference Condition2).
...
if (nrow(M_ca) == 0L) {
  ...
  message("Saved AOC_multiverse_sternberg_condition_alpha.png to ", storage_plot)
...
if (nrow(M_interaction) > 0) {
  ...
  message("Saved AOC_multiverse_sternberg_interaction.png to ", storage_plot)
...
if (nrow(M_cg) == 0L) {
  ...
  message("Saved AOC_multiverse_sternberg_condition_gaze.png to ", storage_plot)
