...
#   multiverse_sternberg_results.csv              — full interaction model terms
#   multiverse_sternberg_conditions_results.csv    — per-condition gaze→alpha
#   multiverse_sternberg_condition_results.csv     — condition→alpha (EEG-only)
#   multiverse_sternberg_interaction_results.csv   — gaze×condition interaction term
#   multiverse_sternberg_condition_gaze_results.csv — condition→gaze (gaze-only)
