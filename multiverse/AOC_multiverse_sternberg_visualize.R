...
if (file.exists(ap_gaze_path)) {
  ...
  ggsave(file.path(storage_plot, "AOC_multiverse_sternberg_aperiodic_gaze.png"),
         plot = p_ap_combined, width = 14, height = 14, dpi = 600)
  message("Saved: AOC_multiverse_sternberg_aperiodic_gaze.png")
} else {
...
if (file.exists(ap_cond_path)) {
  ...
  ggsave(file.path(storage_plot, "AOC_multiverse_sternberg_aperiodic_condition.png"),
         plot = p_apc_combined, width = 14, height = 10, dpi = 600)
  message("Saved: AOC_multiverse_sternberg_aperiodic_condition.png")
} else {
