...
set(low_group_plot.mainLine, 'Color', colors(1,:), 'LineWidth', 3);
set(high_group_plot.mainLine, 'Color', colors(3,:), 'LineWidth', 3);
...
set(difference_plot.mainLine, 'Color', [0.1 0.1 0.1], 'LineWidth', 3);
