...
for subj = 1:n_subj
    ...
    allgazebase2{subj} = extract_gaze_window(et, idx2, [-1.5 -0.5], x_grid, y_grid, fsample, smoothing);
    allgazebase4{subj} = extract_gaze_window(et, idx4, [-1.5 -0.5], x_grid, y_grid, fsample, smoothing);
    allgazebase6{subj} = extract_gaze_window(et, idx6, [-1.5 -0.5], x_grid, y_grid, fsample, smoothing);
